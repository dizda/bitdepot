...
class LoadAddressData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $address1 = (new Address())
            ...
            ->setPubKeys([
                '021bb3d58673ba887980a91d4a56fdeaaf263f500e3db581bec3140b684895a9df',
                '0244d61e612701fbefe46feb51ced989473a1c83233aaaca16c27a4fa8511df459',
                '0364759d648cbf406eed9b68d01c7cc7ebbdadb966472b042c8fcf538505ba9542'
            ])
        ...
        $address2 = (new Address())
            ...
            ->setPubKeys([
                '025fa6de2cebb0d6a33f3d0d6f02639ae9679b7db977a0b3bc00541830a7944024',
                '0290b020f94903144c87810bbd95bf023bb923154923a34c90ea47343744192c08',
                '03eb3ff8af9eb5a406665d8a33fe86e4d7b7a4648c614dc3275e09729c4ab24f4e'
            ])
            ->setApplication($this->getReference('application-1'))
        ;
        ...
        $address3 = (new Address())
            ...
            ->setPubKeys([
                '02087a30059abeb82ceb8b0a0413c16307a0d29cec97073bbc8d4a584e60f19f23',
                '029bfbac8f2bfca762df3ecd1500bdf291a9dad7c7491533a8b6d8925c9039432f',
                '02a3ce2f9b90ac59d6cd5a2a01b3c1d5e9e379627ae9c9e1b2a3542f8cf80f7ae7'
            ])
            ->setApplication($this->getReference('application-1'))
        ;
        ...
        $address4 = (new Address())
            ...
            ->setPubKeys([
                '0210febba17348636dd1779ca2d86beea81ad065cfea924178bbc296d3c6ed372c',
                '029dd61b0195ff5e69a6dbcc454f30fb55f0deeb34418de576830c674d33a0dbcb',
                '03ad50a5aa6e6210e00bcd95197cc318833f0016c769a7d291ba4fe49e43bed566'
            ])
            ->setApplication($this->getReference('application-1'))
        ;
        ...
        $address5 = (new Address())
            ...
            ->setPubKeys([
                '025c54dfb67d0af92aa3997a23c9ab3f36476071f1130352bbaff2942b95e77035',
                '02e64aaa741dc18c283dc4c16862dbdd16431d0575b11073059354dfa4f10fcf6a',
                '035ebf1e6a067055b3463a01a42eff4755a9e5a57ac19e8e8e6b97e8f77879e4c2'
            ])
            ->setApplication($this->getReference('application-1'))
        ;
